...
export const Profile = () => {
    ...
    return (
        <div className="min-h-screen mb-10 w-full bg-gradient-to-br from-indigo-100 via-purple-50 to-pink-50 flex flex-col">
            <ToastContainer />
            ...
            <nav className="w-full bg-white shadow-md p-4 flex justify-between items-center">
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex gap-4">
                        <a href="#" className="text-gray-600 hover:text-indigo-600 font-medium text-sm">Tổng quan</a>
                        <a href="#" className="text-gray-600 hover:text-indigo-600 font-medium text-sm">Khóa học</a>
                        <a href="#" className="text-gray-600 hover:text-indigo-600 font-medium text-sm">Lịch học</a>
                    </div>
                </div>
                <div className="flex items-center gap-2">
                    ...
                    />
                    <span className="text-gray-700 font-medium text-sm">{user?.username || "admin"}</span>
                </div>
            </nav>
                    ...
                    {!user ? (
                        <div className="flex justify-center items-center min-h-[150px]">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-lg text-gray-600 font-medium">Đang tải...</span>
                            </div>
                        </div>
                    ) : (
                        <>
                            ...
                            <div className="space-y-6 text-gray-700 text-base">
                                <div className="flex flex-col p-2 rounded-lg transition-colors duration-200">
                                    ...
                                    <span className="text-gray-800 font-medium">{user.fullname || "Chưa có email"}</span>
                                </div>
                                <div className="flex flex-col p-2 rounded-lg transition-colors duration-200">
                                    <span className="font-medium text-gray-600">Mã số sinh viên:</span>
                                    <span className="text-gray-800 font-medium">{user.username || "Chưa có email"}</span>
                                </div>
                                <div className="flex flex-col p-2 rounded-lg transition-colors duration-200">
                                    <span className="font-medium text-gray-600">Email:</span>
                                    <span className="text-gray-800 font-medium">{user.email || "Chưa có email"}</span>
                                </div>
                                <div className="flex flex-col p-2 rounded-lg transition-colors duration-200">
                                    <span className="font-medium text-gray-600">Giới tính:</span>
                                    <span className="text-gray-800 font-medium">
                                        {user.gender === true ? "Nam" : user.gender === false ? "Nữ" : "Chưa xác định"}
                                    </span>
                                </div>
                                <div className="flex flex-col p-2 rounded-lg transition-colors duration-200">
                                    <span className="font-medium text-gray-600">Ngày sinh:</span>
                                    <span className="text-gray-800 font-medium">
                                        {user.birth ? new Date(user.birth).toLocaleDateString("vi-VN") : "Chưa có ngày sinh"}
                                    </span>
                                </div>
                                {/* Thêm nút đăng xuất */}
