        ...
        <nav className={`flex-1 bg-gradient-to-b from-blue-50 to-white text-gray-800 pt-4 ${isDesktopCollapsed ? 'text-center' : ''}`}>
            <ul className="mt-20 space-y-2 px-2 py-2">
                {[
                    ...
                    { title: "Giáo Vụ", path: "/admin/manager-eduaffairs", icon: "M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-3.31 0-6 2.69-6 6v2h12v-2c0-3.31-2.69-6-6-6z" },
                ].map((item, index) => (
                    <li key={index}>
                        <Link
                            to={item.path}
