        ...
        <nav className={`flex-1 bg-gradient-to-b from-blue-50 to-white text-gray-800 pt-4 ${isDesktopCollapsed ? 'text-center' : ''}`}>
            <ul className="mt-20 space-y-2 px-2 py-2">
                {[
                    ...
                    { title: "Khóa học", path: "/admin/manager-courses", icon: "M3 6h18v12H3V6zm9 0v12" },
                    { title: "Quản lý lớp", path: "/admin/manager-classes", icon: "M5 5h14v4H5V5zm0 6h14v4H5v-4zm0 6h14v4H5v-4z" },
                    { title: "Giảng Dạy", path: "/admin/manager-assign", icon: "M12 4v6m-6 4h12m-9 4h6" },
                ].map((item, index) => (
                    <li key={index}>
                        <Link
                            to={item.path}
